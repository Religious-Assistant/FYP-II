...
const { registerUser, loginUser, forgotPassword, updateProfileImage, sendOTPCode, verifyOTPCode, updatePassword, deleteUser, updateLocation } = require('../../controllers/common_controllers/userController')
...
user_route.patch('/update-profile-image',updateProfileImage) //authMiddleWare
