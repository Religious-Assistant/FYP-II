...
const { getRecitationStats, updateLastReadSurah, updateLastReadParah, markSurahAsRead, markParahAsRead, markSurahAsUnRead, markParahAsUnRead, checkSurahIsRead, getLastReadSurah, getLastReadParah, checkParahIsRead, getParahs } = require('../../controllers/muslim_user_controllers/reciteQuranController')
