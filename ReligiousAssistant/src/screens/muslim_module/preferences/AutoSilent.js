...
const AutoSilent = () => {
  const time1 =moment('6:40:00 AM', 'HH:mm: A').diff(moment().startOf('day'), 'seconds')
  const time2 =moment('6:37 pM', 'HH:mm: A').diff(moment().startOf('day'), 'seconds')
...
var seconds = (+a[0]) * 60 * 60 + (+a[1]) * 60 + (+a[2]); 
  ...
  //     channelId: 'checkNotification1',
  //     title: 'Namaz Notification',
  //     message: 'Fajr Namaz Time Time 2',
  //     soundName:'azan2.mp3',
  //     importance:4,
  //     vibrate:true,
  //     smallIcon: appIcon,
  //     date: new Date(Date.now() + time2),
  //     allowWhileIdle: true,
  //     // repeatType:'day'
  // });
  ...
  return (
    <View>
      ...
      <Button
        ...
        onPress={() => {
           //handleNoti();
           var hms = '06:40:00';   // your input string
var a = hms.split(':'); // split it at the colons
