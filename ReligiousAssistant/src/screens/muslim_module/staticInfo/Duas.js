...
export default function Duas({navigation}) {
  const duas = [
    ...
    },
    {
      ...
      translation:
        '(1)In the Name of Allah. (2) In the Name of Allah at the beginning and at the end.',
    },
    {
      key: 11,
    ...
    },
    {
      ...
      translation:
        "(1) You should say: 'All praise is for Allah.' (2) Your companion should say 'May Allah have mercy upon you.' (3) You should reply back 'May Allah guide you and rectify your condition.'",
    },
    {
      key: 13,
