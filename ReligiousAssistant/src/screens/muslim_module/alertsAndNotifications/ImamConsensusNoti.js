...
import {
  ...
  getImamById,
  selectImamById,
  selectIsLoadingGetImamById,
} from '../../../redux/slices/muslim_module_slices/imamSlice';
...
export default function ImamConsensusNoti({route, navigation}) {
  ...
  const cast_upVote = () => {
    const index = imamById?.receivers.findIndex(
    ...
    if (
      ...
      !isAlreadyCasted &&
      user &&
      !imamById?.receivers[index].hasVoted
    ) {
      ...
      <View style={styles.maincontainer}>
        <View
          ...
          <View style={{flex: 0.5, alignItems: 'flex-end'}}>
            <Image
              source={{uri:'https://res.cloudinary.com/nadirhussainnn/image/upload/v1663584491/religious-assistant/static_assets/vote_ic_n61hyf.png'}}
              style={{
                marginTop: '10%',
                marginRight: '5%',
                marginBottom: '5%',
        ...
        {isLoadingImamById ? (
          ...
          <Box
            ...
            <Box
              ...
              <DetailItem
                heading={'Mosque Name'}
                data={imamById?.mosque?.mosqueName.toUpperCase()}
              />
              <DetailItem
