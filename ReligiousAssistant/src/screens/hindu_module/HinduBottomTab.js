    ...
    return(
        <>
            ...
            >
                ...
                />
                <BottomTab.Screen name="FindTemple" component={FindTemple} 
                     options={{
                        // tabBarLabel:'Home',
                        headerShown:false,
                        tabBarIcon:({focused})=>(
                            <Image source={require('../../../assets/images/search_temple_ic.png')}
                                resizeMode='contain'
                                style={{
                                    width:50,
                                    height:50,
                ...
                <BottomTab.Screen name="Prayers" component={Prayers}
                 options={{
                    // tabBarLabel:'Home',
                    headerShown:false,
                    tabBarIcon:({focused})=>(
                        <View style={{alignItems:'center', justifyContent:'center', top:10}}>
                            <Image source={require('../../../assets/images/info_ic1.png')}
                                resizeMode='contain'
                                style={{
                                    width:25,
                                    height: 25,
