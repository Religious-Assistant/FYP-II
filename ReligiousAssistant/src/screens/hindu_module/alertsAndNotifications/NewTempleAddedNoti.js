...
import { getTempleById, selectIsLoadingGetTempleById, selectTempleById } from '../../../redux/slices/hindu_module_slices/templeSlice';
import { updatePrimaryTemple } from '../../../redux/slices/hindu_module_slices/hinduPreferencesSlice';
 ...
 export default function NewTempleAddedNoti({route, navigation}) {
   ...
   const displayLocationOnMap = destinationCoordinates => {
     navigator.navigate(GOOGLE_MAP_DIRECTIONS_FOR_HINDU_USERS, {destinationCoordinates});
   };
