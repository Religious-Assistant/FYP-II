...
import { ENTER_AS_GUEST, LOGIN, OTP_VERIFICATION, SIGNUP, SPLASH_SCREEN } from './constants';
...
function AuthStackNavigation(){
    return(
        ...
        <AuthStack.Navigator initialRouteName={SPLASH_SCREEN} >
            <AuthStack.Screen name={SPLASH_SCREEN} component={SplashScreeen} options={{headerShown:false}} />            
